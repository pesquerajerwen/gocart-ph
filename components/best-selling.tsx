...
const products: ProductWithRating[] = [
  ...
  },
  {
    ...
    description: "High-protein, gluten-free quinoa grains sourced from Peru.",
    actualPrice: 550,
    offerPrice: 499,
    stock: 200,
    rating: 4.5,
    status: "active",
    storeId: "store_eco_1",
    primaryImageUrl: assets.product_img5,
  ...
  },
  {
    ...
    description: "Durable eco bag made from 100% recycled cotton.",
    actualPrice: 250,
    offerPrice: 199,
    stock: 500,
    rating: 4.2,
    status: "active",
    storeId: "store_green_2",
    primaryImageUrl: assets.product_img6,
    createdAt: new Date("2024-07-19T10:45:00Z"),
  ...
  {
    id: "prod_7",
    name: "Compostable Food Container Set",
    description: "Pack of 5 biodegradable containers for eco-conscious meals.",
    actualPrice: 320,
    offerPrice: 279,
    stock: 250,
    rating: 4.4,
    status: "active",
    storeId: "store_green_2",
    primaryImageUrl: assets.product_img7,
    createdAt: new Date("2024-09-05T12:00:00Z"),
    updatedAt: new Date("2025-02-11T18:00:00Z"),
    categorySlug: "",
    totalRating: 10,
    totalSales: 10,
  },
  {
    id: "prod_8",
    name: "Vegan Chocolate Bar 80%",
    description: "Dark chocolate made from fair-trade cocoa and coconut sugar.",
    actualPrice: 220,
    offerPrice: 190,
    stock: 150,
    rating: 4.9,
    status: "active",
    storeId: "store_naturals_3",
    primaryImageUrl: assets.product_img8,
